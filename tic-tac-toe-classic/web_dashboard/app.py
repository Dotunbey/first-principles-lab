...
# off of. This makes a human opponent a genuinely new kind of training
# partner this project hasn't had before - every other opponent (MCTS,
# perfect solver, self-play) was some form of automated play; a human's
# move choices are a different, less mechanical distribution of experience.
human_game = None  # TicTacToe instance, or None if no game in progress
human_symbol = None
