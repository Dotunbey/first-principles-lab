"""
Monte Carlo Tree Search for classic Tic-Tac-Toe.

Same algorithm as ../sliding-tic-tac-toe/mcts.py - MCTS itself doesn't care
about the specific game rules, only that game_state exposes copy(),
get_valid_moves(), make_move(), game_over, winner, and current_player.
