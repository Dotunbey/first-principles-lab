...
Shows all steps of the learning process in detail
"""
...
def show_complete_learning_process():
    ...
    print(f"✓ AI created with depth={ai.depth}")
    print(f"✓ Learning rate: {ai.learning_rate}")
    print(f"✓ Exploration rate: {ai.exploration_rate}")
    print(f"✓ Initial Q-table size: {len(ai.q_table)}")
    print()
    ...
    print("✓ Created sample expert game database")
    print("✓ Prepared self-play training data")
    print()
    ...
    for i in range(1, 6):
        ...
        print(f"  Game {i} completed - Q-table size: {len(ai.q_table)}")
    ...
    for i, game_data in enumerate(sample_games):
        print(f"  Processing expert game {i+1}: {game_data['id']}")
        print(f"    Moves: {game_data['moves']}")
        print(f"    Comment: {game_data['comments']}")
        ...
        print(f"    Updated Q-values for key moves")
    ...
    print(f"✓ Q-table size: {len(ai.q_table)}")
    print()
    ...
    print("✓ Model saved as 'complete_oware_model.pkl'")
    print("✓ All learning progress preserved")
    print()
